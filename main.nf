/*
 * Copyright (c) 2020, Georgetown University and the authors.
 *
 *   This file is part of 'methylseq-nf' a pipeline repository to using both
 *   Biscuit https://github.com/zhou-lab/biscuit
 *
 *      BISulfite-seq CUI Toolkit (BISCUIT)
 *      is a utility suite for analyzing sodium bisulfite conversion-based DNA
 *      methylation/modification data. It was written to perform alignment,
 *      DNA methylation and mutation calling, allele specific methylation
 *      from bisulfite sequencing data.
 *
 *   and wgbs_tools https://github.com/nloyfer/wgbs_tools
 * 
 *
 *
 * Main methylseq-NF pipeline script
 *
 * @authors
 * Megan Barefoot   <meb@georgetown.edu>
 * Anne Deslattes Mays <ad376@georgetown.edu>
 */

log.info "Paired Methylseq with wgbs_tools - N F  ~  version 0.1"
log.info "====================================="
log.info "Accession list        : ${params.accessionList}"
log.info "Key file              : ${params.keyFile ? params.keyFile : 'Not provided'}"
log.info "Genome fasta file     : ${params.genomeFastaFile}"
